            ...
            {loadingTools ? (
              ...
              <div className="space-y-2 max-h-64 overflow-y-auto">
                {tools.map((tool) => (
                  ...
                  >
                    <Wrench className="w-3 h-3 text-gray-400 dark:text-gray-500 mt-0.5 shrink-0" />
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500 py-2">{t("mcpPage.noToolsAvailable")}</p>
            )}
          </div>
        </div>
      )}
