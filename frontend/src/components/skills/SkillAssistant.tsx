    ...
    <div className="flex flex-col h-full border-l border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 relative animate-[slideInRight_0.2s_ease-out]" style={{ width: panelWidth, minWidth: 250 }}>
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
        <div className="flex items-center gap-2">
          <span className="text-[11px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">AI Assistant</span>
        ...
        <div className="flex items-center gap-1">
          ...
          <button onClick={closePanel} className="p-1 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors" title="Close">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-3 py-3">
        {loading ? (
          ...
          <div className="text-center py-8">
            <p className="text-xs text-gray-400 dark:text-gray-500 mb-2">{t("skillEditor.askModify")}</p>
                  ...
                  <div key={msg.id} className="flex justify-end mb-2">
                    <div className="max-w-[90%] w-full">
                      ...
                      <div className="flex justify-end gap-1 mt-0.5">
                        <button onClick={() => setEditingMsgId(null)} className="text-[10px] px-1.5 py-0.5 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded">Cancel</button>
