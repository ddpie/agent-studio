...
def test_extract_prompt_well_formed():
    ...
    sched = {"Target": {"Input": json.dumps({"Payload": payload})}}
...
def test_schedule_response_shape():
    ...
    sched = {
        ...
        "GroupName": "default",
        "Target": {"Input": json.dumps({"Payload": json.dumps({"prompt": "do work"})})},
    }
...
class TestListSchedules:
    def test_list_empty(
        self, workspace_id, mock_jwt, _mock_viewer, mock_agents_table_for_sched, mock_scheduler
    ):
        mock_agents_table_for_sched.get_item.return_value = {"Item": _agent_in_ws(workspace_id)}
        resp = _invoke(_apigw("GET", f"/api/workspaces/{workspace_id}/agents/agent1/schedules"))
    ...
    def test_list_invalid_id(
        ...
        resp = _invoke(_apigw("GET", f"/api/workspaces/{workspace_id}/agents/has spaces/schedules"))
    ...
    def test_list_no_membership_forbidden(
        self, workspace_id, mock_jwt, _mock_no_membership, mock_agents_table_for_sched, mock_scheduler
    ):
        resp = _invoke(_apigw("GET", f"/api/workspaces/{workspace_id}/agents/agent1/schedules"))
        assert resp["statusCode"] == 403
    ...
    def test_list_other_workspace_forbidden(
        ...
        mock_agents_table_for_sched.get_item.return_value = {"Item": _agent_in_ws("other-ws")}
        resp = _invoke(_apigw("GET", f"/api/workspaces/{workspace_id}/agents/agent1/schedules"))
        assert resp["statusCode"] == 403
...
class TestCreateSchedule:
    ...
    def test_create_success(
        ...
        mock_jwt,
        _mock_editor,
        mock_agents_table_for_sched,
        mock_scheduler,
        configure_scheduler_env,
    ):
        mock_agents_table_for_sched.get_item.return_value = {"Item": _agent_in_ws(workspace_id)}
        ...
        resp = _invoke(
            _apigw(
                "POST",
                f"/api/workspaces/{workspace_id}/agents/agent1/schedules",
                body=self._body(),
            )
        )
    ...
    def test_create_no_role_arn_returns_500(
        self, workspace_id, mock_jwt, _mock_editor, mock_agents_table_for_sched, mock_scheduler, monkeypatch
    ):
        import crud.schedules as s
...
class TestUpdateSchedule:
    ...
    def test_update_invalid_id(
        ...
        resp = _invoke(
            _apigw(
                "PUT",
                f"/api/workspaces/{workspace_id}/agents/has spaces/schedules/x",
                body={"prompt": "new"},
            )
        )
        assert resp["statusCode"] == 400
    ...
    def test_update_name_missing_prefix(
        ...
        resp = _invoke(
            _apigw(
                "PUT",
                f"/api/workspaces/{workspace_id}/agents/agent1/schedules/wrong-prefix",
                body={"prompt": "x"},
            )
        )
        assert resp["statusCode"] == 400
    ...
    def test_update_prompt_success(
        ...
        mock_scheduler.get_schedule.side_effect = [
            self._existing_schedule(),
            {
                **self._existing_schedule(),
                "Target": {
                    **self._existing_schedule()["Target"],
                    "Input": json.dumps(
                        {
...
class TestDeleteSchedule:
    def test_delete_success(
        self, workspace_id, mock_jwt, _mock_editor, mock_agents_table_for_sched, mock_scheduler
    ):
        mock_agents_table_for_sched.get_item.return_value = {"Item": _agent_in_ws(workspace_id)}
        resp = _invoke(
            _apigw(
...
class TestListExecutions:
    def test_invalid_id(self, workspace_id, mock_jwt, _mock_viewer, mock_agents_table_for_sched, mock_logs):
        resp = _invoke(
            _apigw(
                "GET",
    ...
    def test_agent_not_found(
        self, workspace_id, mock_jwt, _mock_viewer, mock_agents_table_for_sched, mock_logs
    ):
        mock_agents_table_for_sched.get_item.return_value = {"Item": None}
        resp = _invoke(
            _apigw(
