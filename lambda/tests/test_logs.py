...
class TestGetAgentLogs:
    def test_returns_events(self, workspace_id, mock_jwt, _mock_viewer, mock_logs, mock_get_agent_item):
        mock_get_agent_item.return_value = {"agentId": "agt1", "workspace_id": workspace_id}
        mock_logs.filter_log_events.return_value = {
            "events": [
                {"timestamp": 1700000001000, "message": "[ERROR] something", "logStreamName": "s1"},
                {"timestamp": 1700000002000, "message": "regular line", "logStreamName": "s2"},
            ],
        }
    ...
    def test_returns_next_cursor(self, workspace_id, mock_jwt, _mock_viewer, mock_logs, mock_get_agent_item):
        mock_get_agent_item.return_value = {"agentId": "agt1", "workspace_id": workspace_id}
        mock_logs.filter_log_events.return_value = {
            "events": [],
            "nextToken": "abc-def",
    ...
    def test_invalid_agent_id(self, workspace_id, mock_jwt, _mock_viewer, mock_logs):
        resp = _invoke(_apigw("GET", f"/api/workspaces/{workspace_id}/agents/bad agt/logs"))
        assert resp["statusCode"] == 400

    def test_agent_not_found(self, workspace_id, mock_jwt, _mock_viewer, mock_logs, mock_get_agent_item):
    ...
    def test_agent_in_other_workspace(
        ...
        mock_get_agent_item.return_value = {"agentId": "agt1", "workspace_id": "other-ws"}
        resp = _invoke(_apigw("GET", f"/api/workspaces/{workspace_id}/agents/agt1/logs"))
        assert resp["statusCode"] == 403

    def test_invalid_since(self, workspace_id, mock_jwt, _mock_viewer, mock_logs, mock_get_agent_item):
        mock_get_agent_item.return_value = {"agentId": "agt1", "workspace_id": workspace_id}
        resp = _invoke(
            _apigw(
                "GET",
                f"/api/workspaces/{workspace_id}/agents/agt1/logs",
    ...
    def test_invalid_level(self, workspace_id, mock_jwt, _mock_viewer, mock_logs, mock_get_agent_item):
        mock_get_agent_item.return_value = {"agentId": "agt1", "workspace_id": workspace_id}
        resp = _invoke(
            _apigw(
                "GET",
    ...
    def test_invalid_search(self, workspace_id, mock_jwt, _mock_viewer, mock_logs, mock_get_agent_item):
        mock_get_agent_item.return_value = {"agentId": "agt1", "workspace_id": workspace_id}
    ...
    def test_valid_since_15m(self, workspace_id, mock_jwt, _mock_viewer, mock_logs, mock_get_agent_item):
        mock_get_agent_item.return_value = {"agentId": "agt1", "workspace_id": workspace_id}
    ...
    def test_valid_since_24h(self, workspace_id, mock_jwt, _mock_viewer, mock_logs, mock_get_agent_item):
        mock_get_agent_item.return_value = {"agentId": "agt1", "workspace_id": workspace_id}
        mock_logs.filter_log_events.return_value = {"events": []}
        resp = _invoke(
            _apigw(
    ...
    def test_no_membership_forbidden(self, workspace_id, mock_jwt, _mock_no_membership, mock_logs):
        resp = _invoke(_apigw("GET", f"/api/workspaces/{workspace_id}/agents/agt1/logs"))
        assert resp["statusCode"] == 403
